 ...
 */
public class CollectionAdapter extends BaseListAdapter<CollectionsBean>{
    public CollectionAdapter(List<CollectionsBean> list, Activity activity) {
        super(list, activity);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        loadImage(list.get(position).getBg_pic().get(0),holder.imageView);
        return convertView;
    }
